...
import com.dongwoo.testnavigation.ui.theme.topAppBarBackgroundColor
import com.dongwoo.testnavigation.ui.theme.topAppBarContentColor
...
fun NewTaskAppBar(
    ...
    TopAppBar(
        ...
        title = {
            Text(
                text = stringResource(R.string.add_task_txt),
